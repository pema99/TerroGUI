## Important note ##
If you get an error while trying to build a game with a reference to TerroGUI, be sure to build the game against .NET 4.5. (Properties -> Application -> Target Framework)
